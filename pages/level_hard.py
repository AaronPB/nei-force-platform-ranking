...
def level_hard():
    ...
    if st.session_state.get("btn_save", False):
        ...
        st.session_state.data_mngr.updateScoreboardHard(
    ...
    if st.session_state.level_recorded:
        ...
        results = st.session_state.data_mngr.getResultsHard(
    ...
    test_info.markdown(
        """
        # ¿:material/road:? -- Camino oculto -- ¿:material/road:?
        
        No puedes ver el camino generado. Se revelará cuando empiece el desafío.
        """
    )
